...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        "Здравствуйте! Я — Закия, практикующий психолог. Работаю в модальности Транзактный анализ. Здесь вы можете узнать обо мне и записаться на сессию.",
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text == "📅 Записаться на консультацию":
        ...
        await update.message.reply_text("Я — Закия, практикующий психолог. Провожу онлайн-сессии, 50 мин, стоимость 4000₽.")
        ...
        await update.message.reply_text("Вот ссылка на мои материалы: https://www.b17.ru/id986545/")
